...
export default function Experience() {
  ...
  useGSAP(
    () => {
      ...
      // The cards mount after an async fetch, so ScrollTrigger's cached start
      // positions were measured against a collapsed, empty section. Without a
    ...
    <section ref={root} id="journey" className="relative py-28 lg:py-40">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="timeline relative mx-auto mt-16 max-w-5xl">
          ...
          {loading ? (
            <div className="text-center text-muted font-mono py-10">Loading experiences...</div>
          ) : (
