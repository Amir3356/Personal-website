  ...
  return (
    ...
    >
      ...
      <div className="hero-content relative z-10 mx-auto w-full max-w-7xl px-6 pt-28 pb-20 lg:px-10 lg:pt-24 lg:pb-0">
        <div className="grid items-center gap-14 lg:grid-cols-[minmax(0,6fr)_minmax(0,4fr)] lg:gap-28 xl:gap-40">
          {/* Copy */}
          <div className="max-w-xl">
            {/* min-h reserves two lines so typing never shifts the content below */}
            <h1 className="hero-title min-h-[2.3em] max-w-[18ch] font-display text-[clamp(2rem,3.2vw,3.3rem)] leading-[1.08] font-extrabold tracking-tight [&_.hero-char]:inline-block">
              <span
          ...
          {/* Portrait */}
          <div className="hero-photo relative mx-auto w-full max-w-[16rem] sm:max-w-[19rem] lg:mr-0 lg:ml-auto">
